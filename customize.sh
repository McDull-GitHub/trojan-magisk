...
unzip -j -o "${ZIPFILE}" "trojan/etc/appid.list" -d /data/trojan >&2
...
ln -s /data/trojan/resolv.conf $MODPATH/system/etc/resolv.conf # TODO: Read-only file system
# generate module.prop
ui_print "- Generate module.prop"
rm -rf $MODPATH/module.prop
touch $MODPATH/module.prop
echo "id=trojan" > $MODPATH/module.prop
echo "name=Trojan4Android" >> $MODPATH/module.prop
echo -n "version=Module v1.0.0, Core " >> $MODPATH/module.prop
echo ${latest_trojan_version} >> $MODPATH/module.prop
echo "versionCode=20201217" >> $MODPATH/module.prop
echo "author=McDull-GitHub" >> $MODPATH/module.prop
echo "description=Trojan for Android" >> $MODPATH/module.prop
